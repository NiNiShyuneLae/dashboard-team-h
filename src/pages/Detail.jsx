      ...
      <div className="py-8">
        ...
        <div className="detail  mt-7  ">
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2  gap-5 mt-5 p-0">
            <div className=" col-span-1 bg-cardColor rounded-lg p-10">
              <div className="flex justify-between">
                <div className=" mb-5">
                  <h4 className=" text-base font-semibold text-white">
                    Tasks Summary
                  </h4>
                  <p className=" text-primary text-sm">24 Overdue Tasks</p>
                </div>
                <div className="">
              ...
              <div className="flex lg:items-center flex-col lg:flex-row gap-10 mb-14">
                ...
                <div className="flex  flex-col  gap-3">
                  ...
                  <div className="flex justify-between items-center gap-5">
                    ...
                    <p className="text-gray-400 font-medium text-[16px]">0</p>
                  </div>
                  <div className="flex justify-between items-center gap-5">
                    <div className="flex items-center gap-4">
              ...
              <div className="h-auto border-[1px] border-primary border-dashed rounded-lg bg-cardColor">
                <p className=" p-5 text-textColor">
            ...
            <div className=" col-span-1 bg-cardColor rounded-lg pe-10 py-10">
              <div className="flex justify-between">
            ...
            <div className=" col-span-1 bg-cardColor rounded-lg p-10">
              ...
              <div className="flex mt-5 w-full">
                <label
                  ...
                  className="flex items-center w-full h-auto p-5 border-[1px] border-primary border-dashed rounded-lg cursor-pointer bg-cardColor "
                >
                  <div className="flex items-center  gap-3">
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2  gap-5 mt-5 p-0">
            <div className=" col-span-1 bg-cardColor rounded-lg p-10">
              <div className="flex justify-between">
                <div className=" mb-5">
                  <h4 className=" text-base font-semibold text-white">New Contibutors</h4>
                  <p className=" text-primary text-sm">
            ...
            <div className=" col-span-1 bg-cardColor rounded-lg p-10">
              <div className="flex justify-between">
                <div className=" mb-5">
                  <h4 className=" text-base font-semibold text-white">My Tasks</h4>
                  <p className=" text-primary text-sm">
